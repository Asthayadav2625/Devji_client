      ...
      <div className="max-w-screen-lg mx-auto p-6">
        ...
        <div className="space-y-12 mt-10">
          ...
          <div className="flex flex-col md:flex-row items-start">
            ...
            <div className="md:ml-8 text-justify">
              <p className="text-lg text-black">
                We offer a range of <Link to='/fellowship' className="text-sky-400">fellowship programs</Link> for aspiring ophthalmologists looking to <Link to={Services} className="text-sky-400 ">specialize in cataract surgery</Link>, surgical retina, glaucoma, cornea-anterior segment and refractive surgery, squint and pediatric ophthalmology, orbit and oculoplasty, and phaco and refractive surgery. Our <Link to='/fellowship' className="text-sky-400">fellowship programs</Link> are designed to provide hands-on training and practical experience to young ophthalmologists to excel in their chosen field.
                <br/><br/>
